...
class TestResolver:
    ...
    def test_add_param(self, graph: ResolutionGraph, resolver: ResolverNode.ResolverNode):
    ...
    def test_remove_param(self, graph: ResolutionGraph, resolver: ResolverNode.ResolverNode):
